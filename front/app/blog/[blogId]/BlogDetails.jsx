        ...
        {blog.comments &&
          ...
          blog.comments.map((comment) => (
            <div key={comment._id} className="py-5 flex">
              ...
              <div className="px-4">
                <h1 className="capitalize text-sm text-third font-semibold">
                  {comment.author}
                </h1>
                <span className="text-xs text-[#5ece60] border-[#5ece60c1]">
                ...
                {comment.canReply && (
                  <>
                    <span
                      className="text-xs text-third cursor-pointer"
                      ...
                      <div key={reply.id}>
                        <div className="py-5 flex">
                          ...
                          <div className="px-4">
                            ...
                            <span className="text-xs text-[#5ece60]  px-2 ">
                            ...
                            <p className="text-neutral-600 text-sm pb-2">
                              {reply.content}
                            </p>
