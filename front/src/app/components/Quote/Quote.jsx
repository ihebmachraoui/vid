...
const QuoteGenerator = () => {
  ...
  const apiKey = 'xUEZ5QaHoXwye6LCooXROw==86zR9LYY4QQ9NBJz';
      ...
      {loading ? (
        ...
        quote && (
            ...
            <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
              ...
              <p className="leading-relaxed text-lg lg:text-2xl capitalize">{quote.quote}</p>
              ...
              <h2 className="text-gray-900 font-medium title-font tracking-wider text-normal mt-8">{quote.author}</h2>
            </div>
          </div>
        )
      )}
