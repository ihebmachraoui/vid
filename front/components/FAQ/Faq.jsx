...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum officiis reprehenderit ex quia ducimus minima id provident molestias optio nam vel, quidem iure voluptatem, repellat et ipsa.',
    },
    {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="max-w-5xl px-4 py-10 mx-auto lg:px-0">
        <h1 className="text-2xl font-semibold text-neutral-600 lg:text-3xl">FAQ's</h1>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="mb-4">
              ...
              >
                ...
                <h1 className="mx-4 text-xl text-left text-neutral-600">{faq.question}</h1>
              </button>
