		...
		<div className="p-16 ">
			<div className="grid-2 grid   md:grid-cols-1 lg:grid-cols-2">
				<div className="flex  items-center px-12">
					<div className="hidden lg:block   bg-gradient-to-t from-[#0ba360] to-[#3cba92] rounded-3xl">
						<div className="flex justify-center items-center p-2">
							...
							<p className="text-white text-7xl font-eduVic">Ally</p>
						</div>
						<p className="text-white  text-lg  text-center px-7 ">
							Empowering individuals and organizations with sociology insights.
							<br /> Expert online consulting to navigate social dynamics and
							achieve your goals.
						</p>
						<div className="bg-transparent w-full h-auto py-8 px-1 flex items-center justify-center gap-4 flex-wrap">
							<button className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white  shadow-gray-200 group transition-all duration-300">
								<svg
							...
							<button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white  shadow-gray-200 group transition-all duration-500">
								<svg
							...
							<button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white  shadow-gray-200 group transition-all duration-300">
								<svg
			...
			<div className="container px-1 sm:px-6 text-center text-xl">
				<span>© {currentYear} </span>
				<span className="font-sans">Copyright:</span>
				<a className="font-semibold font-mono  ml-1">JWEJEM</a>
			</div>
		</div>
